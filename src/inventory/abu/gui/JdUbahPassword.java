...
public class JdUbahPassword extends javax.swing.JDialog {
    ...
    private void UbahPassword(){
        if(jTextField1.getText().isEmpty()){
            ...
            loginmodel = login.ProsesLogin(jTextField1.getText(), jPasswordField1.getText());
            if(loginmodel.isEmpty()){
                JOptionPane.showMessageDialog(null,"Username atau Password Lama tidak sesuai !!");
                jTextField1.requestFocus();
                
            }else{
                login.setUsername(jTextField1.getText());
                login.setPassword(jPasswordField2.getText());
                login.UbahPassword();
                jTextField1.setText("");
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/inventory/abu/icon/User-Interface-Password-icon (1).png"))); // NOI18N
